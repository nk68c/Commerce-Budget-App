...
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head runat="server">
		...
		<title>Commerce App - Summary</title>
					...
					<div id="content" class="col-xs-10">
						<div id="contentHeader" class="col-xs-12">
							<div class="col-xs-12 textLeft">
								<h4><b>View your spending, top goals, and important budgets.</b></h4>
							</div>
						</div>
                        ...
                        <br/>
                                <div class="col-xs-12" style="margin-bottom: 1em;">
                                    <div class="col-xs-12">
                                        <h3>Favorite Goals</h3>
                                    </div>
                                    <div class="col-xs-6" style="padding-top: 1em;">
                                        <h5>Manage your goals on the Goals page.</h5>
                                    </div>
                                    <div class="col-xs-6" style="padding-top: 1em;">
                                        <div id="gotoGoalsBtn" class="darkBtn textCenter"><h5>Go to Goals</h5></div>
                                    </div>
                                </div>
						<asp:ListView ID="FaveGoalsList" runat="server">
						<LayoutTemplate>
						...
						<ItemTemplate>
							...
							<div class="col-xs-12 itemHeader" runat="server">
								...
								<!-- Goal Date should be more professionally formatted. -->
